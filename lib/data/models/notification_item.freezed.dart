...
abstract class $NotificationItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, String message, bool isUnread});
}
...
class _$NotificationItemImpl implements _NotificationItem {
  ...
  @override
  String toString() {
    return 'NotificationItem(id: $id, title: $title, message: $message, isUnread: $isUnread)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, title, message, isUnread);
