...
import '../../../logic/worker/wallet_summary.dart';
...
class _WalletBody extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final theme = Theme.of(context);
    final summary = computeWalletSummary(earnings);
    final paidTotal = summary.paidTotal;
    final pendingTotal = summary.pendingTotal;
    final monthTotal = summary.monthTotal;
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          _BalanceStat(label: 'Tháng này', value: vndFormat.format(monthTotal)),
                          const SizedBox(width: 24),
                          _BalanceStat(label: 'Đang chờ', value: vndFormat.format(pendingTotal)),
                        ],
                      ),
                    ],
                  ),
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      earning.earnedAt != null
                          ? dateTimeFormat.format(earning.earnedAt!)
                          : '',
                    ),
                    trailing: Column(
                      ...
                      children: [
                        Text(
                          vndFormat.format(earning.amount),
