...
import '../../worker/dashboard/worker_active_job_bar.dart';
import '../../worker/shared/worker_suspension_banner.dart';
...
class WorkerShell extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final onlineStatus = ref.watch(workerOnlineStatusNotifierProvider).valueOrNull;
