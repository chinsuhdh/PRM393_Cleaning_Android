...
import 'widgets/display/booking_action_bar.dart';
import 'widgets/display/booking_info_cards.dart';
import '../../shared/app_error_view.dart';
import '../../shared/app_loading_indicator.dart';
import '../../shared/app_snackbar.dart';
import 'widgets/maps/nearby_workers_google_map.dart';
import 'widgets/maps/live_tracking_map.dart';
import 'widgets/display/reschedule_banner.dart';

part 'widgets/detail/booking_detail_action_handlers.dart';
part 'widgets/detail/booking_detail_cancellation_handlers.dart';
part 'widgets/detail/booking_detail_payment_handlers.dart';
part 'widgets/detail/booking_detail_reschedule_handlers.dart';
...
class _BookingDetailScreenState extends ConsumerState<BookingDetailScreen> {
  ...
  Widget _rescheduleBanner(BuildContext context, WidgetRef ref, Booking booking) => RescheduleBanner(
        ...
        currentUserId: ref.watch(authNotifierProvider).userId,
