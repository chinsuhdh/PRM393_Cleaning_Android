...
import '../../../../../logic/booking/slot_rules.dart';

class SlotPicker extends StatefulWidget {
  static const int leadHours = slotLeadHours;
  static const int maxDaysAhead = slotMaxDaysAhead;
...
class _SlotPickerState extends State<SlotPicker> {
  ...
  bool _isSlotEnabled(DateTime candidate) => isSlotEnabled(candidate, DateTime.now());
